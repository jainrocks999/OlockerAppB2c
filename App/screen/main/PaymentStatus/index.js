    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={{paddingHorizontal: 10}}>
          ...
          <View style={[styles.top]}>
            ...
            <View
              ...
              <Image
                ...
                source={require('../../../Assets/images/successful_icon.png')}
              />
            </View>
          </View>
          <View style={styles.main}>
            <Text style={{marginTop: 0}}> Order date : 18-06-2021</Text>
            <Text style={{marginTop: 4}}>PAYMENT REFERENCE NUMBER</Text>
            <Text
              style={{
                fontSize: 16,
                color: 'black',
        ...
        <View style={{marginTop: 10, alignItems: 'center'}}>
          <Image
            style={{height: 200, width: 290, borderWidth: 2}}
            source={require('../../../Assets/images/payment_card.png')}
          />
        </View>

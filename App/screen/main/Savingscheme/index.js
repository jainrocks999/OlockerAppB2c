        ...
        <SafeAreaView style={styles.container}>
            <ScrollView style={{ paddingHorizontal: 10,}}>
                <View style={styles.card}>
                    ...
                    <Text style={[styles.title,{fontWeight:'700',marginLeft:5}]}>AJMJ-16</Text>
                    </View>
                       <View>
                    ...
                    <View style={styles.main}>
                       <Text style={{fontSize:17,color:'black',fontWeight:'500',marginLeft:10}}>Akshay Jewels, Jalgaon</Text>
                       <View style={[styles.top,{marginTop:10}]}>
                       <Text style={{marginLeft:10}}>Start date</Text>
                       <Text style={{marginLeft:55,color:colors.blue}}>24 June 2020</Text>
                        <View/>
                       </View>
                       <View style={[styles.top,{marginTop:10}]}>
                       <Text style={{marginLeft:10}}>Maturity date</Text>
                       <Text style={{marginLeft:37,color:colors.blue}}>24 June 2020</Text>
                        <View/>
                       </View>
                       <View style={[styles.top,{marginTop:10}]}>
                       <Text style={{marginLeft:10}}>Next payment date</Text>
                       <Text style={{marginLeft:-3,color:colors.blue}}>24 June 2021</Text>
                        <View/>
                       </View>
                       <View style={styles.card1}>
                        <View style={{backgroundColor:'#6bcb3d',width:'50%',paddingVertical:6,borderRadius:15}}>
                       ...
                       <View>
                       <Text style={{marginLeft:30,color:'#6bcb3d',fontWeight:'500'}}>₹ 2500</Text>
         ...
         style ={[styles.button,{width:"45%",backgroundColor:'#6bcb3d',marginLeft:25}]}>  
             <Text style={{color: '#fff',fontSize:15,fontFamily:'Acephimere',fontStyle:'italic'}}>MAKE PAYMENT</Text>
           ...
           style ={[styles.button,{width:"35%",marginLeft:-10}]}> 
             ...
             <Text style={{color: '#fff',fontSize:15,fontFamily:'Acephimere',fontStyle:'italic'}}>REFUND</Text>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.main}>
                       ...
                       <View style={[styles.top,{marginTop:10}]}>
                       <Text style={{marginLeft:10}}>Maturity date</Text>
                       <Text style={{marginLeft:33,color:colors.blue}}>24 June 2020</Text>
                        <View/>
                       </View>

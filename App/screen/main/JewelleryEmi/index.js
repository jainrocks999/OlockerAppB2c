    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.view3}>
          ...
          <View style={styles.view2}>
            ...
            <View >
            <Text style={[styles.text1,{marginLeft:10}]}>Emi Schedule</Text>
            </View>
            <View >
      ...
      <View style={styles.main1}>
        <View style={styles.title}>
          ...
          <Text style={styles.text3}>Your personal data will be shared with the relevant jeweller who will offer EMI option to buy Jewellery</Text>
        </View>
        ...
        <View style={styles.main4}>
                      ...
                      <RNPickerSelect
                                      ...
                                      placeholder:{color:'grey',fontSize:14,borderWidth:0}
                                      }}
                                      value={gender}
              ...
              <TouchableOpacity
                ...
                <Text style={{ marginLeft: 3, fontSize: 14,marginTop:16,fontFamily:'Acephimere',color:'grey'}}>{`${date2}`}</Text>
              </TouchableOpacity>
              {show && (
                <DateTimePicker
              ...
              <View style={styles.loanv}>
                <View style={{alignSelf:'center'}}>
                 <Text style={{fontFamily:'Acephimere',marginLeft:3,color:colors.blue}}>Loan Needed</Text>
                </View>
                <View style={styles.loanview}>
                   <View style={{alignSelf:'center'}}>
                    ...
                    <TextInput
                     style={{width:'85%',fontSize:15,color:'#ed6660'}}
             ...
             <View style={[styles.check,{backgroundColor:'#fff'}]}>
                <HStack space={4}>
               <Checkbox value="check" colorScheme="orange"  accessibilityLabel="This is a dummy checkbox" 
              //  defaultIsChecked  
               />
        ...
        <View style={styles.main4}>
              <TextInput
                      placeholder='Your current total EMI (if you pay any)'
                     />
         </View>

      ...
      <ScrollView>
        <View style={styles.buttonView}>
          <TouchableOpacity
            ...
            style={[styles.button]}>
            <Text
              style={{color: '#fff', fontSize: 15, fontFamily: 'Acephimere'}}>
              Add New Jeweller
            </Text>
          </TouchableOpacity>
        ...
        <ImageBackground
          ...
          <View style={{paddingHorizontal: 5}}>
            <FlatList
              ...
              horizontal={true}
              data={DATA}
              style={{marginTop: 7, paddingHorizontal: 0}}
              renderItem={({item}) => (
                <TouchableOpacity
          ...
          <View style={styles.buttonv1}>
            <TouchableOpacity
              ...
              <Text style={[styles.text2, {fontSize: 14}]}>VIEW ALL</Text>
            </TouchableOpacity>
          </View>
        </ImageBackground>
        <ImageBackground
          source={require('../../../Assets/images/olocker_logo_home_bg.jpg')}
          style={styles.fotter}>
                  ...
                  {index == 0 ? (
                    <TouchableOpacity
                      ...
                      <View style={styles.img2}>
                        <Image
                          style={styles.img3}
                          source={require('../../../Assets/images/olocker_logo_homebx1.jpg')}
                        />
                    ...
                    <TouchableOpacity
                      ...
                      <View style={styles.img2}>
                        <Image
                          style={styles.img3}
                          source={require('../../../Assets/images/olocker_logo_homebx2.png')}
                        />
                        <View style={styles.cardimg}>
                          <Image
                            style={styles.img4}

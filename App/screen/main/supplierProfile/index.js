      ...
      <ScrollView style={styles.main}>
        <View>
              ...
              renderItem={({item, index}) => (
                <View>
                  {index == 0 ? (
                    ...
                    <TouchableOpacity
                      onPress={() => navigation.navigate('saving12')}
                      style={styles.cardview1}>
                      {/* <Text>{item.title}</Text> */}
                      <Image
                        style={{
          ...
          <View style={styles.fotter}>
            <Text style={styles.textV}>WOMEN'S JEWELLERY</Text>
          </View>
          <View style={{marginRight: 0}}>
            <ImageBackground
              source={require('../../../Assets/images/customer_speak.png')}
              style={styles.view}>
              <Text style={styles.textV}>CUSTOMER'S SPEAK</Text>
            </ImageBackground>

      ...
      <ScrollView style={{paddingHorizontal: 5}}>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>
            Your feedback on overall shopping experience with us
          </Text>
          <View style={styles.line} />
          <View style={styles.main}>
            ...
            <View style={{marginTop: 10}}>
              <HStack space={2}>
                <Checkbox value="check" colorScheme="orange" />
            ...
            <View style={{marginTop: 10}}>
              <HStack space={2}>
                ...
                />
                <Text style={styles.text2}>
                  you were properly treated by staff
                </Text>
              </HStack>
            </View>
          </View>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>
            Any suggestion to improv your overall experience
          </Text>
          <View style={styles.line} />
          <View style={styles.main}>
            <TextInput
              style={{width: '100%', borderBottomWidth: 0.3}}
        ...
        <View style={styles.card}>
          <Text style={styles.title}>
            {'Rate Us Between 1 to 10 ,1 being the best & 10 words?'}
          </Text>
          <View style={styles.line} />
          <View style={styles.main}>
            <TextInput

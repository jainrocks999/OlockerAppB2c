        ...
        <View style={styles.main1}>
          <View style={styles.top}>
            <View style={{height: 80}}>
              <Text style={styles.text}>{'Please fill up the form'}</Text>
              <Text style={[styles.text, {fontSize: 26}]}>{'to complete'}</Text>
              <Text style={[styles.text, {fontSize: 26, marginLeft: 0}]}>
                registration
              </Text>
            </View>
            <View style={styles.imgbcg}>
              <Image
                style={styles.img}
                source={require('../../../Assets/images/registration_img.png')}
              />
            </View>
          </View>

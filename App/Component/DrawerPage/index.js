    ...
    <SafeAreaView style={{flex: 1}}>
      <DrawerContentScrollView style={{height: '100%'}}>
        ...
        <ScrollView
            ...
            <View style={[styles.drawer]}>
              <View style={{flexDirection: 'row'}}>
                <View style={[styles.iconView, {width: 14}]}>
                  <Image
                    style={[styles.imageicon, {marginLeft: 3}]}
                    source={require('../../Assets/icon/sid_jeweller.png')}
                  />
                </View>
            ...
            <View>
              <TouchableOpacity
                ...
                <View
                  style={[
                    styles.drawer,
                    {backgroundColor: 'pink', borderBottomWidth: 0.5},
                  ]}>
                  <View style={{flexDirection: 'row', paddingHorizontal: 20}}>
                    <View style={[styles.iconView, {width: 22}]}>
                      <Image
                        style={styles.imageicon}
                        source={require('../../Assets/icon/sid_retailer.png')}
                      />
                    </View>
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('Addjeweller');
                }}>
                <View style={[styles.drawer, {backgroundColor: 'pink'}]}>
                  <View style={{flexDirection: 'row', paddingHorizontal: 25}}>
                    <View style={[styles.iconView, {width: 17}]}>
                      <Image
                        style={[styles.imageicon, {marginLeft: -1}]}
                        source={require('../../Assets/icon/sid_add_jeweller.png')}
                      />
                    </View>
            ...
            <View style={[styles.drawer]}>
              <View
                ...
                <View style={[styles.iconView, {width: 20, marginRight: 1}]}>
                  <Image
                    style={styles.imageicon}
                    source={require('../../Assets/icon/sid_my_olocker.png')}
                  />
                </View>
            ...
            <View>
              <TouchableOpacity onPress={() => navigation.navigate('MyFav')}>
                <View
                  style={[
                    styles.drawer,
                    {backgroundColor: 'pink', borderBottomWidth: 1},
                  ]}>
                  <View style={{flexDirection: 'row', paddingHorizontal: 23}}>
                    <View style={[styles.iconView, {width: 20}]}>
                      <Image
                        style={[styles.imageicon, {marginRight: 3}]}
                        source={require('../../Assets/icon/sidmenu_myinsuredjewellery.png')}
                      />
                    </View>
              ...
              <TouchableOpacity
                ...
                <View style={[styles.drawer, {backgroundColor: 'pink'}]}>
                  <View style={{flexDirection: 'row', paddingHorizontal: 23}}>
                    <View style={[styles.iconView, {width: 20}]}>
                      <Image
                        style={[styles.imageicon, {marginLeft: 1.5}]}
                        source={require('../../Assets/icon/sidmenu_myjewelleryportfolio.png')}
                      />
                    </View>
            ...
            <View style={[styles.drawer]}>
              <View
                ...
                <View style={[styles.iconView, {width: 18}]}>
                  <Image
                    style={styles.imageicon}
                    source={require('../../Assets/icon/sid_my_deals.png')}
                  />
                </View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('alldeal')}>
            <View style={[styles.drawer]}>
              <View
                style={{
                  flexDirection: 'row',
            ...
            <View style={[styles.drawer]}>
              <View
                ...
                <View style={[styles.iconView, {width: 17}]}>
                  <Image
                    style={styles.imageicon}
                    source={require('../../Assets/icon/sid_my_points.png')}
                  />
                </View>
      ...
      <View style={{bottom: 0}}>
        <TouchableOpacity
          ...
          style={[
            styles.drawer,
            {backgroundColor: '#ed6660', paddingVertical: 11},
          ]}>
          <View
            style={{
              flexDirection: 'row',
